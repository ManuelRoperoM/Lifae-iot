...
//   }
//   if(otherMillis-previousMillis >= 10000){
//     sendToBackendAsync(p);
...
//   asyncClient->onConnect([data, asyncClient, client](void* arg, AsyncClient* asyncClient){
...
//     client->setInsecure();  // Usar conexión segura sin verificar certificados (puedes ajustar según tus necesidades)
//     if (client->connect(serverAddress, serverPort)) {
//       client->print(postRequest);
      
//       // //Leer la respuesta del servidor (opcional, depende de tus necesidades)
...
//   asyncClient->connect(serverAddress, serverPort);
// }